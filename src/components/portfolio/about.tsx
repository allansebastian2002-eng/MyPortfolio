        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <div className="pt-4">
              ...
              <div className="flex flex-wrap gap-x-3 gap-y-2 text-sm text-foreground/70 font-light">
                {COURSEWORK.map((c, i) => (
            ...
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-px bg-border border border-border">
              {STATS.map((stat) => (
                <div key={stat.label} className="bg-background p-5 sm:p-6">
                  <div className="font-display text-4xl sm:text-5xl font-bold tracking-[-0.03em] text-foreground">
                    {stat.value}
                  </div>
                  <div className="mt-1 text-sm text-foreground/60 font-light">
                    {stat.label}
                  </div>
                </div>
              ))}
